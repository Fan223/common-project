...
public class UserController {
    ...
    public Result addUser(@RequestBody UserCommand userCommand) {
    ...
    public Result updateUser(@RequestBody UserCommand userCommand) {
    ...
    public Result deleteUser(@RequestBody UserCommand userCommand, Principal principal) {
